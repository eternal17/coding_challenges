/*
You will be given an array of arrays and your task will be 
...
function solve(arr) {
  // map would give a new array with subarray with all the dupes removed

  // then reduce to get the final number
